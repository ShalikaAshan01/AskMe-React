...
import {
    fn_downVoteQuestion, fn_followQuestion, fn_getQuestionByAsk,
    fn_getQuestionByID,
    fn_upVoteQuestion
...
class TagAskList extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        fn_getQuestionByAsk(this.props.match.params.tagName)
            .then(data => {
                this.setState({
